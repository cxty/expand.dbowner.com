...
class DBOwnerOAuth {
	 ...
	 */
	function __construct($client_id, $client_secret, $access_token = NULL, $refresh_token = NULL ,$host=null) {
	 ...
	 * @return array
	 */
	function getAuthorizeURL($accessTokenURL, $url, $response_type = 'code', $state = NULL, $display = NULL ,$seArr=false ) {
		$params = array();
